    ...
    <nav>
        <div class="nav-bar"> 
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    <li><a href="login_2.0.html">Login / Register</a></li>
                    <li><a href="productos.php">Product</a></li>
              ...
              echo "<div class='forms'>";
                echo "<div class='form-content'>";
                  echo "<div class='login-form'>";
                    ...
                    echo "<form method='post' action='ini_work.php'>";
                      echo "<div class='input-boxes'>";
                        ...
                        echo "<input type='password' name='contrasena' placeholder='Introduce tu contraseña' required>";
                        echo "</div>";

                        echo "<div class='input-box'>";
                        echo "<i class='fas fa-lock'></i>";
                        echo "<input type='password' placeholder='Introduce la clave de trabajador' name='clave' required>";
                        echo "</div>";
            ...
            <form action="reg_work.php">
                <div class="input-boxes">
                  ...
                  <div class="input-box">
                    ...
                    <input type="password" placeholder="Introduce tu contraseña" name="contra" required>
                  </div>
                  <div class="input-box">
                    <i class="fas fa-lock"></i>
                    <input type="password" placeholder="Introduce la clave de trabajador" name="clave" required>
                  </div>
