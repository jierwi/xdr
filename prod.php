...
<body>
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="search-box">
        <a href="prod.php"><i class='bx bx-revision' ></i></a>
      </div>
      <?php
        ...
        <div class="recent-sales box">
          ...
          <div class="button">
            <form method="post" action="edit.php">
              ...
              <a href="prod.php"><input type="hidden" name="edit" value="prod">
              <input type="submit" class="sb" value="Editar"></a>
            </form>
          </div>
        </div>
        <div class="top-sales box">
          <div class="title">Últimos productos vendidos</div>
          <ul class="top-sales-details">
          <?php
            $prod2 = "SELECT productos.tipo FROM productos, productos_pedidos WHERE productos.idProductos=productos_pedidos.idProductos";
            $resultado = mysqli_query( $conexion, $prod2) or die ( "Algo ha ido mal en la consulta a la base de datos");
            while ($columna = mysqli_fetch_array( $resultado )){
                echo "<li>" . $columna['0'] . "</li>";
            }
