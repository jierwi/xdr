  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Proyectos</span>
      </div>
      <div class="search-box">
        
      </div>
      <div class="search-box">
        <a href="proyectos.php"><i class='bx bx-revision' ></i></a>
      </div>
      <?php
        ...
        <div class="recent-sales box">
          ...
          <div class="button">
            <form method="post" action="edit.php">
              ...
              <a href="proyectos.php"><input type="hidden" name="edit" value="proyectos">
